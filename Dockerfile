...
RUN wget https://hydra.iohk.io/build/8175490/download/1/cardano-node-1.31.0-linux.tar.gz \
    && mkdir -p cardano-node db/testnet cardano-node/node-ipc/testnet \
    && tar -xzvf cardano-node-1.31.0-linux.tar.gz --directory ./cardano-node \
